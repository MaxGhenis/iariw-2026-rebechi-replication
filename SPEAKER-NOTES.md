...
## 5 · What followed
Title base = 2008 (the last pre-ruling cycle, $207M in their categories) — the paper's own "less than $100 million" uses 2004 and carves out 2008 in a parenthetical; don't repeat it. The paper's Table 1 in full (federal outside spending, OpenSecrets), with both sides summed — so nobody in the room sees only the 353× endpoint. Their headline ratio sits on a $4M base that also excludes 2004's 527 committees (≈ $595M per CRS). Since 2016 the two sides are within ~10% (2016: 735 vs 654; 2024: 2,174 vs 1,985). The † footnote: the 2020 column as printed sums to $3,569M, above OpenSecrets' 2020 total ($2,914M excl. parties; $3,309M all groups — verified on opensecrets.org 23 Aug), and 'for Republicans' repeats 'against Republicans' (961); by subtraction the correct figure would be ≈ $281M, which would put 2020 Democratic-aligned ahead (1,605 vs ≈ 1,284) — say 'likely a transcription slip', not more. Their rows reconcile with OpenSecrets' independent expenditures + communication costs, excluding party committees (2004: 64 + 30 = 94; 2008: 144 + 64 = 207). Disclosure share 77% → 33% (Table 3).
...
Joint pre-trend tests pass in the main spec: p > 0.10 (corp&union RS 0.102, top 1% 0.166); in Appendix D the corp&union RS pre-test is p = 0.085 (Table D-3). Don't say "no pre-trends" — comment 2 shows the drift. Post corp&union: top 1% p = 0.025, RS 0.049, top 5% 0.052. Ban-type differences post: < 0.01 for the top-group rates, 0.025 RS; ATR 0.086. Effects build gradually.
...
- OpenSecrets by-cycle totals (verified in-browser 23 Aug; excl. party committees): 2004 $193M (IE 64 + EC 99 + CC 30), 2008 $338M, 2012 $1,038M, 2016 $1,411M, 2020 $2,914M (all groups $3,309M), 2024 $4,218M.
